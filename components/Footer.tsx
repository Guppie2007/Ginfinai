...
const Footer: FC = () => {
  ...
  return (
    <footer className="bg-gray-900/95 border-t border-purple-500/30 mt-24 pt-12 pb-6">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-purple-300 neon-text-sm">{t('tagline')}</p>
            ...
            <div className="flex gap-4 pt-4">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" className="w-6 h-6 text-white">
          ...
          {/* Navigation Section */}
          <div>
            <h4 className="text-white font-semibold mb-4 text-lg neon-text">{t('menu_title')}</h4>
          ...
          {/* Contact Section */}
          <div>
            <h4 className="text-white font-semibold mb-4 text-lg neon-text">{t('contact_title')}</h4>
            <ul className="space-y-2">
              <li className="text-purple-300 neon-text-sm">
                <a href="mailto:info@ginfinai.be" className="hover:text-white transition-colors">
                  info@ginfinai.be
                </a>
              </li>
              <li className="text-purple-300 neon-text-sm">
                <a href="tel:+32498420178" className="hover:text-white transition-colors">
                  +32 498 42 01 78
                </a>
              </li>
              <li className="text-purple-300 neon-text-sm">Notestraat 64, 1742 Ternat</li>
              <li className="text-purple-300 neon-text-sm">BTW BE1012.619.721</li>
            </ul>
          </div>

          {/* CTA Section */}
          <div className="flex flex-col justify-between">
            <h4 className="text-white font-semibold mb-4 text-lg neon-text">{t('cta_title')}</h4>
            <a
              href="mailto:info@ginfinai.be"
        ...
        <div className="pt-6 border-t border-purple-500/30">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-6">
              <a
                href="/privacy"
                className="text-purple-300 hover:text-white transition-colors neon-text-sm text-sm"
              >
                {t('privacy')}
              </a>
              <a
      ...
      {/* Global styles for footer-specific elements */}
      <style jsx>{`
        .neon-text-sm {
